...
import { NEXT_PUBLIC_API_SUB_KEY } from "../../configs/constants"

/** Client requests go through the Next.js API proxy (same-origin) to avoid CORS and referrer policy issues. */
