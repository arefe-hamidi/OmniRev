...
Base URL of the main API to which server-side requests are sent. Used in `proxyFetch` and `serverProxyFetch` functions. If unset, defaults to `https://api-mock.omnirev.ai`.
